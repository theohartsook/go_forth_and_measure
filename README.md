This is some code that turns GoPro videos into images with the appropriate tags for structure from motion software. It can export images for Pix4D and RealityCapture. GFAM uses a JSON file to read the desired settings. Here is an example template: 
```
{
